...
You will only be turning in Assignment #2 Bluestem Analysis, so **YOU DO NOT NEED TO EXPORT THESE FINCH FIGURES** for your lab today. However, if you ever want to save figures from R and put them in a Microsoft Word document, here are directions for doing that:
...
Look in Files tab in RStudio and you'll see a file named **beak_length_histogram.png** now. You can click it to open the file in your computer's default image viewer.
